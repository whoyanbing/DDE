...
/* harmony import */ var _progress_kendo_angular_grid__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @progress/kendo-angular-grid */ "./node_modules/@progress/kendo-angular-grid/dist/fesm5/index.js");
...
/* harmony import */ var _progress_kendo_angular_dateinputs__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @progress/kendo-angular-dateinputs */ "./node_modules/@progress/kendo-angular-dateinputs/dist/fesm5/index.js");
...
var ExportStructureComponent = /** @class */ (function () {
    function ExportStructureComponent(http, bsModalRef) {
        this.http = http;
        this.bsModalRef = bsModalRef;
        this.isSuccessful = false;
    }
    ExportStructureComponent.prototype.ngOnInit = function () {
    };
    ExportStructureComponent.prototype.export = function () {
    ...
    return ExportStructureComponent;
}());
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.insert = function () {
        var initialState = {
    ...
    HeaderComponent.prototype.import = function () {
        var _this = this;
        var initialState = {
            table_name: this.tableName,
            title: 'Modal with component'
        };
        this.bsModalRef = this.modalService.show(_import_import_component__WEBPACK_IMPORTED_MODULE_3__["ImportComponent"], { initialState: initialState });
        this.bsModalRef.content.closeBtnName = 'Close';
        this.modalService.onHidden.subscribe(function (r) {
            _this.outChildMsg.emit("import:finished");
        });
    };
    HeaderComponent.prototype.drop = function () {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.getChildMsg = function (childmsg) {
        this.tablename = childmsg;
        this.product.createTable(childmsg);
    };
    HomeComponent.prototype.getSearchContent = function (childmsg) {
    ...
    HomeComponent.prototype.getOperationTable = function (childmsg) {
...
var ImportStructureComponent = /** @class */ (function () {
    function ImportStructureComponent(http, bsModalRef, activeRoute, router) {
        this.http = http;
        this.bsModalRef = bsModalRef;
    ...
    ImportStructureComponent.prototype.ngOnInit = function () {
    };
    ImportStructureComponent.prototype.addInput = function () {
        this.elements.push({ "name": "", "type": "", "length": "" });
    };
    ImportStructureComponent.prototype.removeInput = function (item) {
        console.log(item);
        var i = this.elements.indexOf(item);
        console.log(i);
        this.elements.splice(i, 1);
    };
    ImportStructureComponent.prototype.changeway = function () {
        console.log(this.chooseImportWay);
    };
    ImportStructureComponent.prototype.uploadFile = function (event) {
        this.selectedFile = event.target.files[0];
    };
    ImportStructureComponent.prototype.import = function () {
        var _this = this;
        var e_1, _a;
        if (this.chooseImportWay == 'file') {
            var fd = new FormData();
            fd.append('file', this.selectedFile, this.selectedFile.name);
            this.datasource = this.http.post('http://127.0.0.1:8081/importTableMysql?tableName=' + this.tableName, fd).map(function (res) { return res.toString; });
            ...
            var sql = "";
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.elements), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            this.datasource = this.http.get("http://localhost:8081/createTableOracle?tableName=" + this.tableName + "&column_information=" + sql).map(function (res) { return res.toString; });
    ...
    return ImportStructureComponent;
}());
...
var ImportComponent = /** @class */ (function () {
    function ImportComponent(http, bsModalRef, activeRoute, router) {
        this.http = http;
        this.bsModalRef = bsModalRef;
        this.activeRoute = activeRoute;
        this.router = router;
    ...
    ImportComponent.prototype.uploadFile = function (event) {
        this.selectedFile = event.target.files[0];
    };
    ImportComponent.prototype.fileUpload = function () {
        var _this = this;
        var fd = new FormData();
        fd.append('file', this.selectedFile, this.selectedFile.name);
        console.log(fd);
        // this.datasource=this.http.post('http://127.0.0.1:8081/importMysql?tableName='+this.table_name,fd).map(res =>res.toString);
        this.datasource = this.http.post(this.apiBase + '/importOracle?tableName=' + this.table_name, fd).map(function (res) { return res.toString; });
        this.datasource.subscribe(function (res) {
            if (res != null) {
                console.log(res);
                alert("import successfully");
...
/* harmony import */ var rxjs_add_operator_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/add/operator/map */ "./node_modules/rxjs-compat/_esm5/add/operator/map.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _progress_kendo_angular_intl__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @progress/kendo-angular-intl */ "./node_modules/@progress/kendo-angular-intl/dist/fesm5/index.js");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../environments/environment */ "./src/environments/environment.ts");
...
var InsertComponent = /** @class */ (function () {
    function InsertComponent(http, activeRoute, router, intl) {
        this.http = http;
        this.activeRoute = activeRoute;
        this.router = router;
        this.intl = intl;
    ...
    InsertComponent.prototype.ngOnInit = function () {
        ...
        var columnSource = this.http.get(this.apiBase + '/tableDetailOracle?tableName=' + tableNameUppercase).map(function (res) { return res.json(); });
        columnSource.subscribe(function (data) {
            var e_1, _a;
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](data.rows), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var iterator = _c.value;
                    // mysql
                    //this.column_names.push(iterator["column_name"]);
                    //this.column_values[iterator["column_name"]]="";
                    //oracle
                    _this.column_names.push(iterator.join(''));
                    _this.column_values[iterator.join('')] = "";
                }
            }
            catch (e_1_1) { e_1 = { error: e_1_1 }; }
            finally {
    ...
    InsertComponent.prototype.insert = function () {
        var e_2, _a;
        var d = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["URLSearchParams"]();
        var queryName = "";
        var queryValue = "";
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.column_names), _c = _b.next(); !_c.done; _c = _b.next()) {
                var iterator = _c.value;
    ...
    InsertComponent.prototype.getResearchArea = function () {
        var e_3, _a, e_4, _b;
        var researchAreaCheckedArr;
        var researchAreaCheckedStr = "";
        researchAreaCheckedArr = this.researchAreaValues.map(function (value) {
            if (value.checked) {
                return value.title;
            }
        });
        try {
            for (var researchAreaCheckedArr_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](researchAreaCheckedArr), researchAreaCheckedArr_1_1 = researchAreaCheckedArr_1.next(); !researchAreaCheckedArr_1_1.done; researchAreaCheckedArr_1_1 = researchAreaCheckedArr_1.next()) {
                var item = researchAreaCheckedArr_1_1.value;
                if (item === undefined) {
            ...
            try {
                if (researchAreaCheckedArr_1_1 && !researchAreaCheckedArr_1_1.done && (_a = researchAreaCheckedArr_1.return)) _a.call(researchAreaCheckedArr_1);
            }
        ...
        try {
            for (var _c = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.column_names), _d = _c.next(); !_d.done; _d = _c.next()) {
    ...
    InsertComponent.prototype.handleDateChange = function (value) {
        var e_5, _a;
        try {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(http, activeRoute, router) {
        this.http = http;
        this.activeRoute = activeRoute;
        this.router = router;
...
var ProductComponent = /** @class */ (function () {
    function ProductComponent(http, modalService, activeRoute, router) {
        this.http = http;
        this.modalService = modalService;
        this.activeRoute = activeRoute;
        this.router = router;
    ...
    ProductComponent.prototype.sortChange = function (sort) {
        this.sort = sort;
        this.loadProducts();
    };
    ...
    ProductComponent.prototype.onItemClick = function () {
        this.log('item click');
    };
    ProductComponent.prototype.log = function (event) {
        this.events.push("" + event);
    };
    ProductComponent.prototype.pageChange = function (event) {
        this.skip = event.skip;
        this.loadItems();
    };
    ProductComponent.prototype.loadItems = function () {
        var e_1, _a;
        for (var index = 0; index < this.items.length; index++) {
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.column_names), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var iterator2 = _c.value;
    ...
    ProductComponent.prototype.update = function (_a) {
        var _this = this;
        ...
        this.bsModalRef = this.modalService.show(_update_update_component__WEBPACK_IMPORTED_MODULE_6__["UpdateComponent"], { initialState: initialState });
        this.bsModalRef.content.closeBtnName = 'Close';
        this.modalService.onHidden.subscribe(function (r) {
            _this.createTable(_this.tableName);
        });
    };
    ProductComponent.prototype.createTable = function (tableName) {
        var _this = this;
        ...
        if (tableName != undefined) {
            ...
            columnSource.subscribe(function (data) {
                ...
                _this.column_names.reverse();
                console.log(_this.column_names);
            });
            //this.datasource=this.http.get('http://localhost:8081/tableDetailListMysql?tableName='+tableName).map(res => res.json());
            this.datasource = this.http.get(this.apiBase + '/tableDetailListOracle?tableName=' + tableName).map(function (res) { return res.json(); });
            this.datasource.subscribe(function (data) {
                var allDetailArr = new Array();
                for (var i = 0; i < data.rows.length; i++) {
                    var obj = {};
                    for (var index = 0; index < data.metaData.length; index++) {
                        obj[data.metaData[index].name] = data.rows[i][index];
                    }
                    allDetailArr.push(obj);
                }
                _this.object = allDetailArr;
                _this.items = _this.object;
                _this.loadItems();
    ...
    ProductComponent.prototype.exportSelected = function () {
        var querys = "";
        console.log(this.mySelection);
        for (var index = 0; index < this.mySelection.length; index++) {
    ...
    ProductComponent.prototype.import = function () {
        this.router.navigate(['import'], { queryParams: { tableName: this.tableName } });
    };
    ProductComponent.prototype.search = function (searchValue) {
        var _this = this;
        var queryString = "";
        for (var index = 0; index < this.column_names.length; index++) {
            if (index != 0) {
        ...
        this.datasource = this.http.get('http://localhost:8081/searchMysql?tableName=' + this.tableName + '&queryString=' + queryString).map(function (res) { return res.json(); });
        this.datasource.subscribe(function (data) {
            _this.items = data;
            _this.loadItems();
        });
    ...
    //   }
    // }
    ProductComponent.prototype.removeHandler = function (_a) {
        var _this = this;
        ...
        deleteResult = this.http.get(this.apiBase + "/deleteOracle?tableName=" + this.tableName + "&column_name=ID&name=" + this.items[rowIndex]["ID"]).map(function (res) { return res.json(); });
        deleteResult.subscribe(function (data) {
            if (data.affectedrows != 0) {
                _this.createTable(_this.tableName);
            }
            else {
                _this.deleteSuccessfully = false;
            }
        });
    };
    ProductComponent.prototype.dropTable = function (tablename) {
        var _this = this;
        var deleteResult;
        deleteResult = this.http.get(this.apiBase + "/deleteTableOracle?tableName=" + tablename).map(function (res) { return res.json(); });
        deleteResult.subscribe(function (data) {
            if (data.affectedrows != 0) {
                alert("drop successfully");
                _this.outChildMsg.emit("drop:successfully");
            }
            else {
                _this.deleteSuccessfully = false;
            }
    ...
    ProductComponent.prototype.dataStateChange = function (state) {
        this.state = state;
...
var selectObject = /** @class */ (function () {
    function selectObject(name, isChoose) {
        this.name = name;
...
var ShowTableComponent = /** @class */ (function () {
    function ShowTableComponent(http, modalService, router) {
        this.http = http;
        this.modalService = modalService;
        this.router = router;
        this.apiBase = _environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].apiBase;
    ...
    ShowTableComponent.prototype.ngOnInit = function () {
        this.createTables();
    };
    ShowTableComponent.prototype.createTables = function () {
        var _this = this;
        // console.log('environment', environment);
        this.tableNames = new Array();
        //this.datasource=this.http.get('http://localhost:8081/tableMysql').map(res => res.json());
        this.datasource = this.http.get(this.apiBase + '/tableOracle').map(function (res) { return res.json(); });
        this.datasource.subscribe(function (data) {
            var e_1, _a;
            console.log(data);
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](data.rows), _c = _b.next(); !_c.done; _c = _b.next()) {
                    ...
                    _this.tableNames.push(iterator);
                    _this.outChildMsg.emit(iterator);
                }
            }
            catch (e_1_1) { e_1 = { error: e_1_1 }; }
            finally {
    ...
    ShowTableComponent.prototype.detail = function (tablename) {
        this.router.navigate(['product'], { queryParams: { tableName: tablename } });
    };
    ShowTableComponent.prototype.export = function () {
        var _this = this;
        var initialState = {
            tableList: this.tableNames,
            title: 'Modal with component'
        };
        this.bsModalRef = this.modalService.show(_export_structure_export_structure_component__WEBPACK_IMPORTED_MODULE_6__["ExportStructureComponent"], { initialState: initialState });
        this.bsModalRef.content.closeBtnName = 'Close';
        this.modalService.onHidden.subscribe(function (r) {
            if (_this.bsModalRef.content.isSuccessful) {
                var date = new Date();
                var month = date.getMonth() + 1;
                var monthString = "";
                if (month < 10) {
                ...
                var d = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["URLSearchParams"]();
                var fileName = +date.getFullYear() + "" + monthString + "" + date.getDay() + "" + _this.bsModalRef.content.tableName + ".json";
                d.append("filename", fileName);
                _this.datasource = _this.http.post(_this.apiBase + "/exportTableMysql?tableName=" + _this.bsModalRef.content.tableName, d);
                _this.datasource.subscribe(function (data) {
                    var result = data._body;
    ...
    ShowTableComponent.prototype.choose = function (tableName) {
        this.outChildMsg.emit(tableName);
    };
    ShowTableComponent.prototype.import = function () {
        var _this = this;
        console.log("sss");
        var initialState = {
            title: 'Modal with component'
        };
        this.bsModalRef = this.modalService.show(_import_structure_import_structure_component__WEBPACK_IMPORTED_MODULE_7__["ImportStructureComponent"], { initialState: initialState });
        this.bsModalRef.content.closeBtnName = 'Close';
        this.modalService.onHidden.subscribe(function (r) {
            _this.createTables();
        });
...
var UpdateComponent = /** @class */ (function () {
    function UpdateComponent(http, bsModalRef, activeRoute, router) {
        this.http = http;
        this.bsModalRef = bsModalRef;
        this.activeRoute = activeRoute;
        this.router = router;
    ...
    UpdateComponent.prototype.ngOnInit = function () {
        ...
        var selectSource = this.http.get(this.apiBase + "/objectDetailOracle?tableName=" + this.table_name + "&column_name=ID&name=" + this.column_value).map(function (res) { return res.json(); });
        selectSource.subscribe(function (data) {
            console.log(data);
            for (var index = 0; index < data.metaData.length; index++) {
                console.log(data.rows[index]);
                _this.column_values[data.metaData[index].name] = data.rows[0][index];
            }
        });
        console.log(this.column_values);
    };
    UpdateComponent.prototype.update = function () {
        ...
        this.datasource = this.http.post(this.apiBase + "/updateOracle?name=" + this.column_values['ID'] + "&tableName=" + this.table_name + "&column_name=" + this.column_names[0], d).map(function (res) { return res.json(); });
        console.log(query);
        this.datasource.subscribe(function (data) {
            console.log(data);
            if (data.affectedrows != 0) {
